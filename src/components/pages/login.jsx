        ...
        <main className="min-h-screen overflow-hidden bg-[#f5f7f2] text-[#17251d]">
            <div className="relative mx-auto flex min-h-screen max-w-7xl items-center justify-center px-5 py-10 sm:px-10 lg:justify-between lg:px-16">
                ...
                <section className="relative hidden max-w-md lg:block">
                    ...
                    <p className="mb-5 text-sm font-bold uppercase tracking-[0.25em] text-[#d07939]">
                        Welcome back
                    </p>
                    ...
                    <p className="mt-7 max-w-sm text-lg leading-8 text-[#607167]">
                        Pick up right where you left off and keep everything
                ...
                <section className="relative w-full max-w-md rounded-[2rem] border border-white/80 bg-white/90 p-7 shadow-[0_24px_70px_rgba(34,65,48,0.12)] backdrop-blur sm:p-10">
                    ...
                    <div className="mb-8 lg:hidden">
                        <div className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1d6b4f] font-bold text-white">
                                O
                            </div>
                    ...
                    <div className="mb-8">
                        <p className="mb-2 text-sm font-semibold text-[#d07939]">
                            Good to see you
                        </p>

                        <h2 className="text-3xl font-black tracking-tight text-[#173a2d]">
                            Log in to onedrive
                        </h2>
                    ...
                    >
                        <div>
                            <label
                                className="mb-2 block text-sm font-bold text-[#30453a]"
                                htmlFor="email"
                            >
                                Email address
                            </label>
                            ...
                            <input
                                className="w-full rounded-xl border border-[#dce5dd] bg-[#f9fbf8] px-4 py-3.5 text-[#173a2d] outline-none transition placeholder:text-[#a3b0a7] focus:border-[#1d6b4f] focus:ring-4 focus:ring-[#1d6b4f]/10"
                                id="email"
                                name="email"
                        ...
                        <div>
                            <div className="mb-2 flex items-center justify-between gap-3">
                                <label
                                    className="block text-sm font-bold text-[#30453a]"
                                    htmlFor="password"
                                >
                                    Password
                                </label>
                                ...
                                <a
                                    className="text-xs font-bold text-[#1d6b4f] hover:underline"
                        ...
                        <button
                            className="w-full rounded-xl bg-[#1d6b4f] px-4 py-3.5 font-bold text-white shadow-lg shadow-[#1d6b4f]/20 transition hover:bg-[#15543d] focus:outline-none focus:ring-4 focus:ring-[#1d6b4f]/20"
                            type="submit"
                        >
                            Log in
                        </button>
                    ...
                    <p className="mt-7 text-center text-sm text-[#718077]">
                        New to onedrive?{" "}
                        <a
                            className="font-bold text-[#1d6b4f] hover:underline"
                            href="/signup"
                        >
                            Create an account
                        </a>
